...
var BuildId = "OGMfLIAbY60GvHuUJzhpu";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/auth/callback/route": "/auth/callback", "/icon.svg/route": "/icon.svg", "/(public)/about/page": "/about", "/(public)/directory/[slug]/page": "/directory/[slug]", "/(public)/groups/page": "/groups", "/(public)/directory/page": "/directory", "/member-access/page": "/member-access", "/login/page": "/login", "/(public)/groups/[id]/page": "/groups/[id]", "/page": "/", "/join/apply/page": "/join/apply", "/(admin)/admin/join-requests/page": "/admin/join-requests", "/(member)/member/endorsements/page": "/member/endorsements", "/(member)/member/groups/page": "/member/groups", "/(member)/member/groups/[slug]/page": "/member/groups/[slug]", "/(admin)/admin/page": "/admin", "/(member)/member/posts/new/page": "/member/posts/new", "/(member)/member/referrals/page": "/member/referrals", "/(member)/member/page": "/member", "/(admin)/admin/reports/page": "/admin/reports", "/(member)/member/feed/page": "/member/feed", "/(member)/member/profile/page": "/member/profile" };
