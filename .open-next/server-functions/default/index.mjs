...
var BuildId = "S3XQpfwEJsYhi9auOj8JF";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/auth/callback/route": "/auth/callback", "/icon.svg/route": "/icon.svg", "/_not-found/page": "/_not-found", "/(public)/about/page": "/about", "/(public)/groups/page": "/groups", "/(public)/directory/[slug]/page": "/directory/[slug]", "/(public)/groups/[id]/page": "/groups/[id]", "/login/page": "/login", "/join/apply/page": "/join/apply", "/page": "/", "/member-access/page": "/member-access", "/(public)/directory/page": "/directory", "/(admin)/admin/join-requests/page": "/admin/join-requests", "/(admin)/admin/reports/page": "/admin/reports", "/(admin)/admin/page": "/admin", "/(member)/member/feed/page": "/member/feed", "/(member)/member/following/page": "/member/following", "/(member)/member/groups/[slug]/page": "/member/groups/[slug]", "/(member)/member/page": "/member", "/(member)/member/referrals/page": "/member/referrals", "/(member)/member/groups/page": "/member/groups", "/(member)/member/posts/new/page": "/member/posts/new", "/(member)/member/lists/page": "/member/lists", "/(member)/member/profile/page": "/member/profile", "/(member)/member/endorsements/page": "/member/endorsements" };
