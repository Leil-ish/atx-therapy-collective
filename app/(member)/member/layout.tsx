...
const memberNav = [
  ...
  { href: "/member/following", label: "Following" },
  { href: "/member/lists", label: "Curated lists" },
    ...
    <div className="min-h-screen bg-background">
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-6 py-10">
        <header className="flex flex-col gap-5 rounded-[32px] border bg-white/85 p-6 shadow-soft md:flex-row md:items-end md:justify-between">
          <div>
            <p className="text-sm uppercase tracking-[0.2em] text-muted-foreground">Private trust workspace</p>
            <h1 className="font-serif text-4xl">Trusted network</h1>
            <p className="mt-2 text-sm text-muted-foreground">Signed in as {session.fullName} · {session.membershipTier} tier</p>
          </div>
